...
const splitType = ref('pages'); // 'pages' or 'range'
const pageRanges = ref('1-5, 6-10'); // For range splitting
...
const canSplit = computed(() => {
    return selectedDocument.value && splitType.value;
});
...
const splitPDF = () => {
    ...
    if (splitType.value === 'range') {
        data.ranges = pageRanges.value;
    }
    
    router.post(route('documents.split', selectedDocument.value), data, {
        onFinish: () => {
                            ...
                            <div class="p-6">
                                ...
                                <div v-if="pdfDocuments.length === 0" 
                                    ...
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        Téléchargez un fichier PDF pour pouvoir le diviser.
                                    </p>
                                    <div class="mt-6">
                    ...
                    <div>
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                    ...
                                    <div class="space-y-3">
                                        <div class="flex items-center">
                                            <input 
                                                ...
                                                class="rounded-full border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            />
                                            <label for="split-pages" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                                <div class="font-medium">Une page par fichier</div>
                                                <div class="text-xs text-gray-500">Diviser chaque page en un fichier séparé</div>
                                            </label>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            <input 
                                                ...
                                                class="rounded-full border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                            />
                                            <label for="split-range" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                                <div class="font-medium">Plages de pages personnalisées</div>
                                                <div class="text-xs text-gray-500">Définir des plages de pages spécifiques</div>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Range Input -->
                                <div v-if="splitType === 'range'" class="mb-6">
                                    <label for="page-ranges" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Plages de pages
                                    </label>
                                    <input 
                                        id="page-ranges"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        Utilisez le format: 1-5, 6-10 pour définir les plages
                                    </p>
                                </div>
                                ...
                                <div v-if="!canSplit" class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                    Sélectionnez un PDF pour le diviser
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-300">
                                        <ul class="list-disc pl-5 space-y-1">
                                            <li>La division par page crée un fichier pour chaque page</li>
                                            <li>Les plages permettent de grouper plusieurs pages ensemble</li>
                                            <li>Les nouveaux fichiers apparaîtront dans vos documents</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
